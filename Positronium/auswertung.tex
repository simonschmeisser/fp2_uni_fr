...
\begin{equation*}
 Q(B)/Q(0) = 0.5 + 0.5 \cdot (1 + r \cdot ( \frac{2  \mu }{ \Delta W})^2 \cdot B^2)^{-1} 
\end{equation*}
...
Der Literaturwert [TODO: Staatsexamensarb?] beträgt $\Delta W = 8,412\e{-4} eV$ und liegt also innerhalb der ersten Standartabweichung des von uns ermittelten Wertes. 
